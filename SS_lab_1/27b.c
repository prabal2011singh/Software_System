...
int main()
{
    printf("ls -Rl using execlp comamnd");
    execlp("ls","ls","-Rl", NULL);
    // execlp("ls","ls","-Rl", "./21", NULL); executes the file 21.c
    perror("execlp");
    return 1;
}
...
-rw-rw-r-- 1 prabal-singh prabal-singh   189 Aug 31 13:04 27b.c
...
-rwxrwxr-x 1 prabal-singh prabal-singh 16048 Aug 31 13:04 a.out
