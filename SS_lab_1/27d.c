...
int main()
{
    printf("ls -Rl using execv comamnd\n");
...
-rw-rw-r-- 1 prabal-singh prabal-singh   222 Aug 31 13:14 27d.c
...
-rwxrwxr-x 1 prabal-singh prabal-singh 16096 Aug 31 13:15 a.out
